...
| **WearBubbles** | A Wear OS app that brings iMessage to your smartwatch via BlueBubbles, with a phone companion app for easy setup. View conversations, send replies, receive photos/GIFs, and get real-time notifications on your wrist. | [@mdunlap](https://github.com/mdunlap) | [Repo](https://github.com/mdunlap/WearBubbles/) |   
